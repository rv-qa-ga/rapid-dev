@sqlserver @ado @ado-35505
Feature: Data Engineering Tech Debt VPT Optimization Column Class Of Business - User Story
  As a QA engineer
  I want to validate SQL Server changes for Azure DevOps work item 35505
  ...
  @sqlserver @ado-35505 @priority-high @type-rollback @category-rollback-upgrade-safety
  Scenario: Validate rollback script exists and is tested
    # Test Case ID: WI-35505-TC-01
    # Purpose: Verify that changes can be safely rolled back if needed
    # Priority: High | Type: Rollback | Complexity: Complex
    # SQL Script: src/features/sqlserver/sql-scripts/WI-35505-TC-01.sql
