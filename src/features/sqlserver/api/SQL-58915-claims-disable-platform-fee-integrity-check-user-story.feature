@sqlserver @ado @ado-58915
Feature: Claims - Disable Platform Fee Integrity Check - User Story
  As a QA engineer
  I want to validate SQL Server changes for Azure DevOps work item 58915
  ...
  @sqlserver @ado-58915 @priority-high @type-rollback @category-rollback-upgrade-safety
  Scenario: Validate rollback script exists and is tested
    # Test Case ID: WI-58915-TC-01
    # Purpose: Verify that changes can be safely rolled back if needed
    # Priority: High | Type: Rollback | Complexity: Complex
    # SQL Script: src/features/sqlserver/sql-scripts/WI-58915-TC-01.sql
