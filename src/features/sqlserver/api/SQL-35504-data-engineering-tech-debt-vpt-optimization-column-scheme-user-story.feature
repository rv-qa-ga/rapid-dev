@sqlserver @ado @ado-35504
Feature: Data Engineering Tech Debt VPT Optimization Column Scheme - User Story
  As a QA engineer
  I want to validate SQL Server changes for Azure DevOps work item 35504
  ...
  @sqlserver @ado-35504 @priority-high @type-rollback @category-rollback-upgrade-safety
  Scenario: Validate rollback script exists and is tested
    # Test Case ID: WI-35504-TC-01
    # Purpose: Verify that changes can be safely rolled back if needed
    # Priority: High | Type: Rollback | Complexity: Complex
    # SQL Script: src/features/sqlserver/sql-scripts/WI-35504-TC-01.sql
