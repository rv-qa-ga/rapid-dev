@sqlserver @ado @ado-58359
Feature: Improve perfomance of D365 Written Pre-Validation checks - this will potentially reap extra benefits
  As a QA engineer
  I want to validate SQL Server changes for Azure DevOps work item 58359
  ...
  @sqlserver @ado-58359 @priority-high @type-rollback @category-rollback-upgrade-safety
  Scenario: Validate rollback script exists and is tested
    # Test Case ID: WI-58359-TC-01
    # Purpose: Verify that changes can be safely rolled back if needed
    # Priority: High | Type: Rollback | Complexity: Complex
    # SQL Script: src/features/sqlserver/sql-scripts/WI-58359-TC-01.sql
