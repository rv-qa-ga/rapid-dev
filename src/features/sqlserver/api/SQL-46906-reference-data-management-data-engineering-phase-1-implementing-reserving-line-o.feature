@sqlserver @ado @ado-46906
Feature: Reference Data Management Data Engineering Phase 1 Implementing Reserving Line of Business Adding Re
  As a QA engineer
  I want to validate SQL Server changes for Azure DevOps work item 46906
  ...
  @sqlserver @ado-46906 @priority-high @type-rollback @category-rollback-upgrade-safety
  Scenario: Validate rollback script exists and is tested
    # Test Case ID: WI-46906-TC-01
    # Purpose: Verify that changes can be safely rolled back if needed
    # Priority: High | Type: Rollback | Complexity: Complex
    # SQL Script: src/features/sqlserver/sql-scripts/WI-46906-TC-01.sql
