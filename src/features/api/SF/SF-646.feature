...
# Generated: 2026-02-22T16:46:21.276Z (FeatureGenerator v3.1)
# ══════════════════════════════════════════════════════════════════════════════
#
...
@api @salesforce @SF-646 @medium @salesforce @field-visibility @opportunity
Feature: API - SF-646 - MOU Data fields- Generate Export
  ...
  @SF-646 @SF-646-API-001 @smoke @p1 @rbt @field-exists
