...
# Generated: 2026-03-10T12:48:14.276Z (FeatureGenerator v3.1)
# ══════════════════════════════════════════════════════════════════════════════
#
# ═══════════════════════════════════════════════════════════════════════════
# GENERATION MODE
...
# ═══════════════════════════════════════════════════════════════════════════
#
# Overview: Finance Review Data Capture
# Primary Entity: Task
#
# Test Requirements (1):
#   REQ-1: Finance fields become required once onboarding review startsGiven
...
@api @salesforce @SF-364 @medium @salesforce @field-visibility @task
Feature: API - SF-364 - Finance Review Data Capture
  ...
  @SF-364 @SF-364-API-001 @smoke @p1 @rbt @field-exists
